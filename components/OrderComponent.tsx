...
const OrderComponent = ({ productCart, modal, setModal }: OrderProps) => {
	...
	return (
		<div className="w-full h-full absolute z-10 left-0 bottom-0 bg-rose-900/50 flex justify-center items-center">
			<div className="w-[40%] bg-primary p-8 rounded-lg flex flex-col gap-8">
				<Order />
				...
				<div className="w-full bg-rose-50 px-4 font-semibold">
					{productCart.map(product => (
						...
						>
							...
							<div className="w-[70%] flex flex-col items-start justify-between gap-2">
				...
				<Button
					className="w-full py-4 px-8 bg-red-100 rounded-full text-primary text-xl font-light"
